...
📍 Based in Madhya Pradesh, India | 💻 Remote-Ready | 🌐 OCI & AI Certified

## 🚀 What I'm Working On
- Building backend workflows with EC2, IAM, Docker, and GitHub Actions
- Documenting cloud labs and automation demos for portfolio
- Preparing for OCI Architect Associate and Azure migration webinars

## 🧠 Skills & Tools
- AWS, OCI, Azure (Learning)
- GitHub Actions, Docker, CI/CD pipelines
- Linux system administration, IAM, SAML SSO
